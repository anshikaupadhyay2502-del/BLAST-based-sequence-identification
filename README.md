...
Prediction: This sequence is a DNA sequence.
...
Open BLASTn
Paste the given DNA sequence into the “Enter Query Sequence” box
Keep all parameters at default settings
Click on BLAST
...
Conclusion: Yes, the alignment supports that this is the same gene.
...
The given unknown sequence is identified as a gene from Zaire ebolavirus. BLAST analysis shows a percentage identity of 100% and an E-value of 4e-109, indicating a very strong and reliable match.
